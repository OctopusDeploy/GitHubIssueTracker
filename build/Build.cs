...
class Build : NukeBuild
{
    ...
    Target Compile => _ => _
        ...
        .Executes(() =>
        {
            Logger.Info("Building GitHub Issue Tracker v{0}", OctoVersionInfo.FullSemVer);
    ...
    Target Pack => _ => _
        ...
        .Executes(() =>
        {
            ...
            DotNetPack(_ => _
                ...
                .SetProperty("NuspecFile", "../../build/Octopus.Server.Extensibility.IssueTracker.GitHub.nuspec")
